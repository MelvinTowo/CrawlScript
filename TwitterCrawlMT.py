...
#     if(maxId <= 0):
#         newTweets = api.search_tweets(q = hashtag, count=tweeesPerQry, result_type="recent", tweet_mode="extended")
#     else:
#         newTweets = api.search_tweets(q = hashtag, count=tweeesPerQry, max_id=str(maxId - 1), result_type="recent", twitter_mode="extended")
#     if not newTweets:
